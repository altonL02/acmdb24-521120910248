...
public class TupleDesc implements Serializable {
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        ...
        if(i < 0 || i >= tdItems.size()){
            throw new NoSuchElementException("index " + i + " not valid");
        }
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        // some code goes here
        if (name == null){
            throw new NoSuchElementException("No fieldName " + name);
        }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        // some code goes here
        TupleDesc new_td = new TupleDesc();
        for(int i = 0;i < td1.tdItems.size();i++){
            new_td.tdItems.add(td1.tdItems.get(i));
        }
        for(int i = 0;i < td2.tdItems.size();i++){
            new_td.tdItems.add(td2.tdItems.get(i));
        }
        return new_td;
    }
